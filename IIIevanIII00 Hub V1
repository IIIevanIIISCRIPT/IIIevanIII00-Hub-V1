...
<!---
IIIevanIIISCRIPT/IIIevanIIISCRIPT is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
if not Executed then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "IIIevanIII00-HUB-V1", Text = "Hello " .. game.Players.LocalPlayer.Name .. " ,welcome to the best DBZFS Hub", Duration = 10})
else
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "IIIevanIII00-HUB-V1", Text = "IIIevanIII00-HUB-V1 ALREADY LOADED", Duration = 10})
	while true do
		task.wait(6000)
	end
end
...
-- [[Made by IIIevanIII00 Discord Server : https://discord.gg/nytHdb3a]] --
-- [[At what are you looking skids]] --

getgenv().Executed = true
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/GreenDeno/Venyx-UI-Library/main/source.lua"))()
local BoogaHub = Library.new("IIIevanIII00-HUB-V1", 5013109572)
...
Plus:addButton("Made By IIIevanIII00", function()
	setclipboard("https://discord.gg/nytHdb3a")
end)
...
Hub:SelectPage(BoogaHub.pages[1], true)
